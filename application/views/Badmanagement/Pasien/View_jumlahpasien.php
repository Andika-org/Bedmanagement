...
<center><h2 style="color:brown" class="pull-" align="center"><b>Data Pasien Rawat Inap Per Tanggal  </b></h2></center>

	<legend>
	</legend>
	
	<form action="<?php print site_url();?>Controlbed/jumlahpasienpertanggal" method="POST">
	<div id="tanggal" style="display:;">
		...
		<div class="input-group date form_date col-md-11" data-date="" data-date-format="dd MM yyyy" data-link-field="dtp_input2" data-link-format="yyyy-mm-dd">
			...
			&nbsp <a href="<?php echo base_url("Controlbed/jumlahpasienpertanggalexcel/".$tglawal.'/'.$tglakhir) ?>" style="margin:0px 0px 0px -8px; height:34px;" class="btn btn-primary glyphicon glyphicon-print"> Print Excel</a>
			</div>
		</div>
        ...
        <thead>
                <tr>
					<th style="vertical-align:middle;"><center>MR</center></th>
					<th style="vertical-align:middle;"><center>Nama Pasien</center></th>
					<th style="vertical-align:middle;"><center>Tanggal Masuk</center></th>
					<th style="vertical-align:middle;"><center>Tanggal Keluar</center></th>
					<th style="vertical-align:middle;"><center>Lama Di Rawat</center></th>
					<th style="vertical-align:middle;"><center>Kelas</center></th>
