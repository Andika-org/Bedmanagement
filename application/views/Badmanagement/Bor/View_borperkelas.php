...
<center><h2 style="color:brown" class="pull-" align="center"><b>Data BOR Per Kelas Rawat Inap </b></h2></center>

	<legend>
	</legend>
	
	<form action="<?php print site_url();?>Controlbor/index" method="POST">
	<div id="tanggal" style="display:;">
		...
		<div class="input-group date form_date col-md-11" data-date="" data-date-format="dd MM yyyy" data-link-field="dtp_input2" data-link-format="yyyy-mm-dd">
			...
			&nbsp <a href="<?php echo base_url("Controlbor/cetakborexcel/".$tglawal.'/'.$tglakhir) ?>" style="margin:0px 0px 0px -8px; height:34px;" class="btn btn-primary glyphicon glyphicon-print"> Print Excel</a>
			</div>
		</div>
        ...
        <thead>
                <tr>
					<th style="vertical-align:middle;"><center>Nama Kelas</center></th>
					<th style="vertical-align:middle;"><center>Bed Allocated</center></th>
					<th style="vertical-align:middle;"><center>Bed Occupied</center></th>
					<th style="vertical-align:middle;"><center>Total BOR Persentase</center></th>
