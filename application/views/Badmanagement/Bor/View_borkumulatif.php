...
<center><h2 style="color:brown" class="pull-" align="center"><b>Data BOR Kumulatif Rawat Inap </b></h2></center>

	<legend>
	</legend>
	
	<form action="<?php print site_url();?>Controlbor/kumulatif" method="POST">
	<div id="tanggal" style="display:;">
		...
		<div class="input-group date form_date col-md-11" data-date="" data-date-format="dd MM yyyy" data-link-field="dtp_input2" data-link-format="yyyy-mm-dd">
			...
			&nbsp <a href="<?php echo base_url("Controlbor/kumulatifcetakexcel/".$tglawal.'/'.$tglakhir) ?>" style="margin:0px 0px 0px -8px; height:34px;" class="btn btn-primary glyphicon glyphicon-print"> Print Excel</a>
			</div>
		</div>
        ...
        <thead>
				<tr>
					<th colspan="<?php echo $span+3; ?>" style="vertical-align:middle;background:#90EE90;"><center>Data Bor Pada Tanggal <?php echo date("d F Y",strtotime($tglawal)); ?> Sampai <?php echo date("d F Y",strtotime($tglakhir)); ?></center></th>
                </tr>
                <tr>
					<th rowspan="2" style="vertical-align:middle;background:#FFEBCD;"><center>Nama Kelas</center></th>
					<th rowspan="2" style="vertical-align:middle;background:#FFEBCD;"><center>Bed Allocated</center></th>
					<th style="vertical-align:middle;background:#D3D3D3;" colspan="<?php echo $span; ?>"><center>Tanggal</center></th>
					<th rowspan="2" style="vertical-align:middle;background:#FFEBCD;"><center>Jumlah</center></th>
                </tr>
				<tr>
				<?php for($i=$tanggalcolomawal+1-1;$i<=$tanggalcolomakhir;$i++){ ?>
					<th style="vertical-align:middle;background:#87CEFA;"><center><?php echo $i; ?></center></th>
				<?php } ?>
                </tr>
              </thead>
