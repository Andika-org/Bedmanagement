...
<center><h2 style="color:brown" class="pull-" align="center"><b>Laporan Bed Dibersihkan </b></h2></center>

	<legend>
	</legend>
	
	<form action="<?php print site_url();?>Controlbed/laporanbed" method="POST">
	<div id="tanggal" style="display:;">
		...
		<div class="navbar-header col-md-4">
            <div class="input-group date form_date col-md-11" data-date="" data-date-format="dd MM yyyy" data-link-field="dtp_input2" data-link-format="yyyy-mm-dd" >
                    <input required class="form-control" type="text" value="<?php echo date("d F Y",strtotime($tglawal)); ?>" name="Tanggal_Awal" placeholder="Tanggal Awal Dibersihkan" readonly="readonly" id="tgl1" onchange="ajaxname();">
		...
		<div class="navbar-header col-md-4">
		<div class="input-group date form_date col-md-11" data-date="" data-date-format="dd MM yyyy" data-link-field="dtp_input2" data-link-format="yyyy-mm-dd">
                    <input required class="form-control" type="text" value="<?php echo date("d F Y",strtotime($tglakhir)); ?>" name="Tanggal_Akhir" placeholder="Tanggal Akhir Dibersihkan" readonly="readonly" id="tgl2" onchange="ajaxname2();">
                    <span class="input-group-addon"><span class="glyphicon glyphicon-remove"></span></span>
					<span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
            </div>
		</div>		
			...
			&nbsp <a href="<?php echo base_url("Controlbed/laporanbedcetakexcel/".$tglawal.'/'.$tglakhir);?>" style="margin:0px 0px 0px -8px; height:34px;" class="btn btn-primary glyphicon glyphicon-print"> Cetak Excel</a>
			</div>
			
			<div class="navbar-header pull-right"  >
			&nbsp <span onclick="printContent('print')" style="margin:0px 0px 0px -100px; height:34px;" class="btn btn-primary glyphicon glyphicon-print"> Cetak</span>
			</div>
		...
		<br>
		<br>
           <table id="table_idbad" class="table table-striped table-bordered" style="width:100%">
        <thead>
                <tr>
					...
					<th><center>Koordinator Kebersihan</center></th>
					<th><center>Tanggal Bersih</center></th>
					<th><center>Petugas Kebersihan</center></th>
                </tr>
              </thead>
