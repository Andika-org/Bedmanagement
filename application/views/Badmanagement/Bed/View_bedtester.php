...
<!--
    <div id="close">
        <div class="container-popup">
			...
			<br>
			<br>
                <img src="<?php echo base_url()?>./assets/images/rshmd.png" alt="">
            </form>
            <a class="close" onclick="interval()" href="#close">close</a>
        </div>
    </div>
	-->
<!-- end popup -->
...
<div class="modal-body">
			...
			<div class="info-box bg-primary">
                ...
                <div class="info-box-content">
				   ...
				   <?php $totalpulang = $jumlahpasienpulang["ttlpulang"]; 
				  if($totalpulang > 0){?>
				  <span class="info-box-text">Terdapat <?php echo $jumlahpasienpulang["ttlpulang"]; ?> Pasien Yang Akan Pulang Hari Ini</span>
				  <?php }else{?>
				    <span class="info-box-text">Tidak Terdapat Pasien Yang Akan Pulang Hari Ini</span>
				  <?php } ?>
				...
				<span class="progress-description">
					<a href="<?php echo base_url("Controlbed/bedpasienpulangsekarang"); ?>" class="fa fa-bed btn btn-default form form-control"> Show More Detail</a>
                </span>
				  <?php }else{?>
				<center><span class="fa fa-bed form form-control" style="background:white"> Didn't Show Data
                </span></center>
				  <?php } ?>
			 ...
			 <div class="info-box bg-green">
                ...
                <div class="info-box-content">
				   ...
				   <?php $totalpulang = $jumlahpasienpulangbesok["ttlpulangbesok"]; 
				  if($totalpulang > 0){?>
				  <span class="info-box-text">Terdapat <?php echo $jumlahpasienpulangbesok["ttlpulangbesok"]; ?> Pasien Yang Akan Pulang Besok</span>
				  <?php }else{?>
				    <span class="info-box-text">Tidak Terdapat Pasien Yang Akan Pulang Besok</span>
				  <?php } ?>
				  ...
				  if($totalpulang > 0){?>
				<span class="progress-description">
					<a href="<?php echo base_url("Controlbed/bedpasienpulangbesok"); ?>" class="fa fa-bed btn btn-default form form-control"> Show More Detail</a>
                </span>
				  <?php }else{?>
				<center><span class="fa fa-bed form form-control" style="background:white"> Didn't Show Data
                </span></center>
...
<div class="modal-body">
		</b><input onclick="closeinterval()" type="checkbox"> Don't Show Again<b>
		 <span onclick="interval()" class="btn btn-danger pull-right glyphicon glyphicon-time" data-dismiss="modal" style="margin-top:-10px;"> Show Me Later</span>
</div>
...
<center><h2 style="color:brown" class="pull-" align="center"><b>Data Akumulasi Bed Managemen  </b></h2></center>
